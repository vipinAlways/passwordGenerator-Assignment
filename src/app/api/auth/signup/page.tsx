  ...
  return (
    <div className="h-full w-full flex justify-center items-center">
      <form
        ...
        className="bg-white/20 backdrop-blur-xl gap-4 border border-white/30 shadow-lg flex min-h-96 justify-around flex-col py-8 px-10 rounded-2xl w-96 mt-20 hover:bg-white/30 hover:shadow-2xl transition-all duration-300"
      >
        ...
        <span className="w-full text-center">
          Don't have Account {""}{" "}
          <Link href={"/api/auth/login"} className="text-sky-900 underline  ">
            Login{" "}
          </Link>
        </span>
      </form>
